...
public class ControllerThread extends Thread {
    ...
    "<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>" + 
    "<P ALIGN=center><a class=\"btn btn-warning\" href=\"/controladorSD/index\">Volver a la pagina principal del Controlador</a></P> <hr />" +
    "<P ALIGN=center> avg41@alu.ua.es </P></BODY></HTML>\n";
    ...
    private void tratarCabecera(String cabecera){
        ...
        "<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js\"></script>" +
        "<script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js\"></script>";
		String finalHTML = "<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><P ALIGN=center><a class=\"btn btn-warning\" href=\"/controladorSD/index\">Volver a la pagina principal del Controlador</a></p> <hr />" +
        "<P ALIGN=center> avg41@alu.ua.es </P></BODY></HTML>\n";
            ...
            if(peticion.contentEquals("ControladorSD")){
                ...
                if(variable.contentEquals("index")){
                    ...
                    for(int i = 1; i <= Naming.list(servidor).length; i++){
                        ...
                        "<input type=\"submit\" class=\"btn btn btn-sm\" name=\"sonda\" value=\"sonda" + i +"\"></li>" +
                    ...
                    data.writeUTF(HTML_START + sondas + "<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p ALIGN=center><a class=\"btn btn-warning\" href=\"/\">Volver al servidor HTTP</a></p> <hr /> <P ALIGN=center>avg41@alu.ua.es </P></BODY></HTML>\n");
